...
const translations = {
  en: {
    ...
    // Product Page
    "product.hero_title": "Meet the NeuroStep Smart Insole",
  ...
  ko: {
    ...
    // Hero Home
    "hero.badge": "스마트 인솔 및 웨어러블 보행 지능",
    "hero.title": "당신의 걸음이 알려주는 건강 이야기.",
    "hero.sub": "개인 맞춤형 보행 평가, 모빌리티 모니터링, 재활 지원 및 웨어러블 보행 연구를 위한 스마트 인솔 기술.",
    "hero.cta_primary": "데모 요청",
    "hero.cta_secondary": "파일럿 프로그램 참여",
    "hero.live_data": "실시간 보행 데이터 Ribbon",

    // Marquee
    "marquee.item1": "보행 타이밍",
    "marquee.item2": "좌우 밸런스",
    "marquee.item3": "족압 분포",
    "marquee.item4": "모션 감지",
    "marquee.item5": "보행 대칭성",
    "marquee.item6": "모빌리티 트렌드",
    ...
    "measures.m1_desc": "입각기, 유각기, 양발 지원 비율 및 보행 주기 시간의 정밀한 측정.",
    "measures.m2_title": "좌우 족압 밸런스",
    "measures.m2_desc": "보행 중 양발 간의 하중 분포 실시간 비교.",
    "measures.m3_title": "족압 분포 매핑",
    "measures.m3_desc": "전족부, 중족부, 후족부 접촉 지점의 영역별 압력 모니터링.",
    "measures.m4_title": "보행 대칭성 지수",
    "measures.m4_desc": "미세한 절뚝거림이나 보상 패턴을 관찰하기 위한 양측 보행 대칭성 정량화.",
    "measures.m5_title": "장기 모빌리티 트렌드",
    ...
    "story.s3_desc": "스탠스 타이밍, 힘 벡터, 족압 맵을 정밀 포착합니다.",
    ...
    "audience.a3_desc": "신경 재활 케어를 위한 종단적 보행 리듬, 보폭 변동성 및 밸런스 모니터링.",
    ...
    "why.f1_desc": "객관적인 측정을 통해 보행 타이밍, 압력 분포, 좌우 밸런스 및 대칭성을 이해합니다. 보행 패턴을 추측하지 말고 측정하세요.",
    ...
    "research.r1_title": "스마트 인솔을 이용한 단계별 보행 특성 분석 및 족부 하중 진행 분석",
    "research.r2_venue": "KMMS 춘계 2025 • 대한민국 서울",
    "research.r2_title": "IoMT 기반 결합 IMU 및 COP 특징 분석을 통한 보행의 종합적 생체역학 분석",
    "research.r2_award": "우수 논문상 (BEST PAPER AWARD)",
    "research.r3_venue": "Sensors 2025 • MDPI 게재",
    "research.r3_title": "웨어러블 압력 인솔을 활용한 파킨슨병 감지를 위한 기능적 모빌리티의 다중 도메인 CoP 특징 분석",
    "research.r3_choice": "EDITOR'S CHOICE 선정",
    "research.view_all": "모든 연구 논문 둘러보기 →",

    // Dynamic Research Counters
    "research.stat_papers": "피어 리뷰 논문",
    ...
    // Research Page
    "research.hero_badge": "피어 리뷰 논문 및 과학적 증거",
    "research.hero_title": "NeuroStep AI의 연구 배경",
    "research.hero_sub": "웨어러블 보행 분석, 족압 센싱, CoP 분석 및 의공학 연구를 바탕으로 제작되었습니다.",
    "research.stat_papers": "피어 리뷰 논문",
    "research.stat_citations": "연구 인용 수",
    "research.stat_awards": "수상 및 표창",
    ...
    "research.p1_title": "웨어러블 압력 인솔을 활용한 파킨슨병 감지를 위한 기능적 모빌리티의 다중 도메인 CoP 특징 분석",
    ...
    "research.p2_title": "종합적 보행 분석을 위한 IoMT 기반 스마트 인솔 시스템: 족압 및 발 운동역학 평가",
    "research.p2_pub_details": "멀티미디어학회논문지 게재, 제28권 제7호, 2025년 7월, Page 807.",
    "research.p2_bullet1": "<strong class=\"text-slate-900\">IoMT 시스템 아키텍처:</strong> 실시간 족압 수집 및 발 운동역학 평가를 위한 종합적 의료사물인터넷(IoMT) 하드웨어-소프트웨어 구조.",
    "research.p2_bullet2": "<strong class=\"text-slate-900\">족압 운동역학 평가:</strong> 입각기 하중 분포 및 뒤꿈치-앞꿈치 이행 과정을 정밀 추적하기 위한 다점 압력 감지 매핑.",
    ...
    "research.p3_category": "Springer Lecture Notes in Electrical Engineering • MITA 2025",
    "research.p3_title": "스마트 인솔을 이용한 단계별 보행 특성 분석 및 족부 하중 진행 분석",
    ...
    "research.p4_title": "IoMT 기반 결합 IMU 및 COP 특징 분석을 통한 보행의 종합적 생체역학 분석",
    "research.p4_pub_details": "한국멀티미디어학회 2025 춘계학술대회 • 중앙대학교, 서울 (2025년 5월 8일–10일)",
    "research.p4_findings": "6축 IMU 가속도 지표와 16개 지점 족압 CoP 특징 추출의 동기화 융합은 단일 센서 방식에 비해 월등히 우수한 생체역학적 보행 평가를 제공합니다.",
    ...
    "research.p4_img3_sub": "발바닥의 16개 핵심 압력 지점",

    // Section 05: Timeline
    "research.timeline_tag": "연구 발전 과정",
    "research.timeline_title": "인터랙티브 연구 및 증거 타임라인",
    ...
    "about.hero_sub": "지능형 웨어러블 기술을 통해 보행 평가를 더욱 쉽게 접근 가능하고, 측정 가능하며, 맞춤화하는 것.",
  ...
  si: {
    ...
    // Hero Home
    "hero.badge": "ස්මාර්ට් ඉන්සෝල් සහ පැළඳිය හැකි ගමන් බිමන් බුද්ධිය",
    "hero.title": "ඔබේ පියවර ඔබේ සෞඛ්‍යය ගැන කියන දේ දැනගන්න.",
    "hero.sub": "පුද්ගලීකරණය කළ ගමන් තක්සේරුව, චලන නිරීක්ෂණය, පුනරුත්ථාපන සහාය සහ පර්යේෂණ සඳහා වූ ස්මාර්ට් ඉන්සෝල් තාක්ෂණය.",
    "hero.cta_primary": "ඩෙමෝ එකක් ඉල්ලන්න",
    "hero.cta_secondary": "පයිලට් වැඩසටහනට එකතු වන්න",
    "hero.live_data": "සජීවී ගමන් දත්ත සටහන",

    // Marquee
    "marquee.item1": "ගමන් කාලය (GAIT TIMING)",
    "marquee.item2": "වම්-දකුණු සමබරතාව",
    "marquee.item3": "යටි පතුලේ පීඩනය",
    "marquee.item4": "චලන සංවේදනය",
    "marquee.item5": "ගමන් සමමිතිය",
    ...
    "measures.sub": "අධි-ඝනත්ව පීඩන සිතියම්කරණය සහ බහු-අක්ෂ සංවේදක මගින් තථ්‍ය කාලීනව චලන භෞතික විද්‍යාව ග්‍රහණය කරයි.",
    "measures.m1_title": "ගමන් කාලය සහ වේගය",
    "measures.m1_desc": "පාදය බිම තබන කාලය, අහසේ පවතින කාලය සහ පියවර චක්‍රයේ නිශ්චිත මැනුම.",
    "measures.m2_title": "වම්-දකුණු පතුලේ සමබරතාව",
    "measures.m2_desc": "ඇවිදීමේදී වම් සහ දකුණු පාද අතර බර බෙදී යාම නිරන්තරයෙන් සංසන්දනය කිරීම.",
    "measures.m3_title": "යටි පතුලේ පීඩන ව්‍යාප්තිය",
    "measures.m3_desc": "පෙර පාදය, මැද පාදය සහ විලුඹ ස්පර්ශ වන ස්ථානවල පීඩනය නිරීක්ෂණය කිරීම.",
    "measures.m4_title": "ඇවිදීමේ සමමිතික දර්ශකය",
    "measures.m4_desc": "කොර ගැසීම් හෝ වෙනත් අසමතුලිතතා හඳුනා ගැනීම සඳහා ප්‍රමාණාත්මක සමමිතික මැනුම්.",
    ...
    "story.s2_desc": "සාමාන්‍ය පරිදි ඇවිදින අතරතුර සංවේදක මගින් දත්ත රැස් කරයි.",
    "story.s3_title": "3. මනින්න (Measure)",
    "story.s3_desc": "පීඩන කලාප සහ චලන දත්ත නිවැරදිව ග්‍රහණය කරගනී.",
    ...
    "audience.a4_desc": "ජෛව කාර්මික විද්‍යාව (Biomechanics) සඳහා ඉහළ නිරවද්‍යතාවයකින් යුත් දත්ත ලබාගැනීම.",
    ...
    "research.r1_title": "Smart Insoles මගින් ඇවිදීමේ අදියර විශ්ලේෂණය සහ පතුලේ බර ප්‍රගතිය මැනීම",
    "research.r2_venue": "KMMS 2025 • සෝල්, දකුණු කොරියාව",
    "research.r2_title": "IoMT පදනම් කරගත් IMU සහ COP විශේෂාංග විශ්ලේෂණය",
    "research.r2_award": "හොඳම පර්යේෂණ පත්‍රිකා සම්මානය (BEST PAPER AWARD)",
    "research.r3_venue": "Sensors 2025 • MDPI ප්‍රකාශනය",
    "research.r3_title": "පාකින්සන් රෝගය හඳුනා ගැනීම සඳහා පළඳින පීඩන ඉන්සෝල් භාවිතයෙන් CoP විශේෂාංග විශ්ලේෂණය",
    "research.r3_choice": "EDITOR'S CHOICE සම්මානය",
    ...
    "product.l_pressure": "පීඩන සංවේදක පද්ධතිය",
    ...
    "solutions.rpm_step4": "වෛද්‍යවරයාගේ සටහන",
    ...
    "research.hero_sub": "පළඳින සංවේදක, පීඩන මැනුම්, CoP විශ්ලේෂණය සහ ජෛව වෛද්‍ය ඉංජිනේරු පර්යේෂණ ඇසුරින් නිර්මාණය කර ඇත.",
    "research.stat_papers": "පර්යේෂණ පත්‍රිකා",
    "research.stat_citations": "පර්යේෂණ උපුටා ගැනීම්",
    "research.stat_awards": "සම්මාන සහ ඇගයීම්",
    ...
    "research.p1_badge": "Impact Factor: 4.0 • Q1",
    "research.p1_choice": "EDITOR'S CHOICE සම්මානය",
    "research.p1_open": "විවෘත ප්‍රවේශය (Open Access)",
    "research.p1_title": "පළඳින පීඩන ඉන්සෝල් භාවිතයෙන් පාකින්සන් රෝගය හඳුනා ගැනීම සඳහා වූ බහු-ක්ෂේත්‍ර CoP විශේෂාංග විශ්ලේෂණය",
    "research.p1_pub_details": "Sensors සඟරාවේ ප්‍රකාශිතයි, කාණ්ඩය 25, කලාපය 18, ලිපිය 5859 (2025 සැප්තැම්බර්)",
    ...
    "research.p1_bullet2": "<strong class=\"text-white\">TUG (Timed Up and Go) ක්‍රමවේදය:</strong> චලන සමබරතාවය සහ හැරීම් පරීක්ෂාවලදී පාකින්සන් රෝගීන් 39 දෙනෙකු සහ පාලන කණ්ඩායම් 38 දෙනෙකු ආශ්‍රයෙන් රෝග විනිශ්චය සාර්ථකත්වය ඇගයීමට ලක් කරන ලදී.",
    "research.p1_bullet3": "<strong class=\"text-white\">යන්ත්‍ර ඉගෙනුම් (Machine Learning) රෝග විනිශ්චය සාර්ථකත්වය:</strong> 핵심 විශේෂාංග 23ක් සහිත WearGait-PD උපකුලකය භාවිතයෙන් ඉහළ රෝග විනිශ්චය නිවැරදිභාවයක් (<strong class=\"text-cyan-300\">ROC-AUC = 0.921</strong>) ලබා ගන්නා ලදී.",
    ...
    "research.p2_title": "සම්පූර්ණ ඇවිදීමේ විශ්ලේෂණය සඳහා IoMT පදනම් කරගත් ස්මාර්ට් ඉන්සෝල් පද්ධතිය: යටි පතුලේ පීඩනය සහ චලන ඇගයීම",
    "research.p2_pub_details": "Journal of Korea Multimedia Society (멀티미디어학회논문지) සඟරාවේ ප්‍රකාශිතයි, කාණ්ඩය 28, අංක 7, 2025 ජූලි, පිටුව 807.",
    ...
    "research.p3_category": "Springer Lecture Notes in Electrical Engineering • MITA 2025",
    "research.p3_title": "ස්මාර්ට් ඉන්සෝල් භාවිතයෙන් ඇවිදීමේ අදියර විශ්ලේෂණය සහ පතුලේ බර ප්‍රගතිය මැනීම",
    ...
    "research.p4_title": "IoMT පදනම් කරගත් IMU සහ COP විශේෂාංග විශ්ලේෂණය මගින් ඇවිදීමේ සම්පූර්ණ ජෛව කාර්මික විශ්ලේෂණය",
    ...
    "contact.form_phone": "දුරකථන අංකය (අයිතිවාසික)",
    "contact.form_interest": "ප්‍රධාන අවධානය",
